...
const securityFeatures = [
  {
    icon: Bot,
    title: 'Auto-Renounce',
    description: 'Ownership automatically renounces in 60 days - no human intervention needed'
  },
  {
    icon: Shield,
    title: 'Rug-Pull Proof',
    description: 'Mathematical guarantee - impossible to prevent decentralization after 60 days'
  },
  {
    icon: Droplets,
    title: 'Zero Fees',
...
const contractLinks = [
    ...
    { name: '🔒 Vesting Contract', address: '0x9cd187f6bCf624c230d21de05Df7d23343Dea16A' },
];
                ...
                >
                    ...
                    <div className="grid md:grid-cols-2 gap-12 text-left relative z-10">
                        <ul className="space-y-6">
                            {[
                                { t: 'Ultimate Security', d: 'No developer can rug pull after 60 days' },
